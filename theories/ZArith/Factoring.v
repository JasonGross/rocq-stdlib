...
#[local] Abbreviation Π := (fold_right Pos.mul 1).
...
#[local] Abbreviation prime := (fun p => Z.prime (Z.pos p)).
...
#[local] Abbreviation expand := (flat_map (fun '(p, k) => repeat p (Pos.to_nat k))).
